...
declare namespace method {
    var returns: <K extends string, T extends SmartContract, R>(returnType: Provable<R>) => (target: T & { [k in K]: (...args: any) => Promise<R>; }, methodName: K & string & keyof T, descriptor: PropertyDescriptor) => void;
}
/**
...
declare class SmartContract extends SmartContractBase {
    ...
    static Proof(): {
        ...
        publicOutputType: import("../provable/types/struct.js").ProvablePureExtended<undefined, null>;
        ...
        }>(this: S, { maxProofsVerified, proof: proofString, publicInput: publicInputJson, publicOutput: publicOutputJson, }: import("../proof-system/zkprogram.js").JsonProof): Proof<InferProvable<S["publicInputType"]>, InferProvable<S["publicOutputType"]>>;
