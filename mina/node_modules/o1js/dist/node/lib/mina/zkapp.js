...
import { cloneCircuitValue, provable, } from '../provable/types/struct.js';
...
import { analyzeMethod, compileProgram, Empty, emptyValue, getPreviousProofsForProver, methodArgumentsToConstant, methodArgumentTypesAndValues, Proof, sortMethodArguments, } from '../proof-system/zkprogram.js';
        ...
        this.sender = {
            ...
            getUnconstrained() {
                ...
                if (__classPrivateFieldGet(this.self, _SmartContract__senderState, "f")?.transactionId === transactionId) {
                    return __classPrivateFieldGet(this.self, _SmartContract__senderState, "f").sender;
                }
                else {
...
class ${contract.constructor.name} extends SmartContract {
  reducer = { actionType: Field };
    ...
    return {
        ...
        reduce(actionLists, stateType, reduce, { state, actionState }, { maxTransactionsWithActions = 32, maxActionsPerMethod = 1, skipActionStatePrecondition = false, } = {}) {
