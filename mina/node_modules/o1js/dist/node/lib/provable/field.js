...
import { FieldType, FieldVar, FieldConst, } from './core/fieldvar.js';
import { exists, existsOne } from './core/exists.js';
import { setFieldConstructor } from './core/field-constructor.js';
import { assertLessThanFull, assertLessThanOrEqualFull, lessThanFull, lessThanOrEqualFull, } from './gadgets/comparison.js';
// external API
export { Field };
// internal API
export { VarField, withMessage, readVarMessage, toConstantField, toFp, checkBitLength, };
/**
...
class Field {
    ...
    isOdd() {
        if (this.isConstant())
            return new Bool((this.toBigInt() & 1n) === 1n);
 ...
 */
Field.sizeInBytes = BinableFp.sizeInBytes;
/**
 * The size of a {@link Field} element in bits - 255.
 */
Field.sizeInBits = Fp.sizeInBits;
