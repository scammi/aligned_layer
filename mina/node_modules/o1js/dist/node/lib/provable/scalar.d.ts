 ...
 * s -> 2s + 1 + 2^255
 */
declare function shift(s: bigint): bigint;
/**
 * inverse of shift, 2s + 1 + 2^255 -> s
 */
declare function unshift(s: bigint): bigint;
declare function constToBigint(x: ScalarConst): bigint;
declare function constFromBigint(x: bigint): ScalarConst;
