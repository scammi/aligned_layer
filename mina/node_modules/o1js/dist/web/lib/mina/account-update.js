import { cloneCircuitValue, provable, provablePure, StructNoJson, } from '../provable/types/struct.js';
...
class AccountUpdate {
    ...
    hash() {
        ...
        if (Provable.inCheckedComputation()) {
            ...
            return Field(Test.hashFromJson.accountUpdate(JSON.stringify(json), NetworkId.toString(activeInstance.getNetworkId())));
        }
    }
