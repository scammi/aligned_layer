...
export { Proof, SelfProof, JsonProof, ZkProgram, verify, Empty, Undefined, Void, VerificationKey, };
...
declare namespace ZkProgram {
    var Proof: <PublicInputType extends FlexibleProvablePure<any>, PublicOutputType extends FlexibleProvablePure<any>>(program: {
        ...
        fromJSON<S extends Subclass<typeof import("./zkprogram.js").Proof>>(this: S, { maxProofsVerified, proof: proofString, publicInput: publicInputJson, publicOutput: publicOutputJson, }: JsonProof): Proof<InferProvable<S["publicInputType"]>, InferProvable<S["publicOutputType"]>>;
        /**
         * Dummy proof. This can be useful for ZkPrograms that handle the base case in the same
         * method as the inductive case, using a pattern like this:
         *
