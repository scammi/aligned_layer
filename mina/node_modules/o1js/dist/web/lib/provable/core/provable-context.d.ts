...
export { snarkContext, SnarkContext, asProver, runAndCheckSync, generateWitness, constraintSystem, constraintSystemSync, inProver, inAnalyze, inCheckedComputation, inCompile, inCompileMode, gatesFromJson, printGates, MlConstraintSystem, };
type SnarkContext = {
    witnesses?: unknown[];
    proverData?: any;
    inProver?: boolean;
 ...
 */
declare function runAndCheckSync(f: () => void): [_: 0, public_inputs: import("../../../bindings/crypto/bindings/vector.js").FieldVector, auxiliary_inputs: import("../../../bindings/crypto/bindings/vector.js").FieldVector];
 ...
 */
declare function constraintSystemSync(f: () => void): {
    rows: number;
    digest: string;
    gates: Gate[];
    publicInputSize: number;
