import { GenericHashInput, GenericProvableExtended, GenericSignable } from '../../bindings/lib/generic.js';
import { BinableWithBits } from '../../bindings/lib/binable.js';
export { signable, ProvableExtended, SignableBigint, BinableBigint, HashInput, Signable, };
type Field = bigint;
